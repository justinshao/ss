...
namespace Common.Utilities
{
    ...
    public enum WinMsg : uint
    {
        ...
        /// Note  The WM_WININICHANGE message is provided only for compatibility with earlier versions of the system. Applications should use the WM_SETTINGCHANGE message.
        /// </summary>
        SETTINGCHANGE = WinMsg.WININICHANGE,
        /// <summary>
    ...
    /// 
    /// </summary>
    public enum WindowOtherStyles : uint
    {
        SS_LEFT = 0x00000000,
    ...
    public class Win32API
    {
        ...
        public static extern uint CreateWindowEx(
            uint dwExStyle,
            string lpClassName,
            string lpWindowName,
            uint dwStyle,
        ...
        /// <returns></returns>
        [Obsolete("This method will crash on 64-bit operating systems. Use GetClassLongPtr instead"), DllImport("user32.dll")]
        ...
        /// <returns></returns>
        [Obsolete("This method will crash on 64-bit operating systems. Use SetClassLongPtr instead"), DllImport("user32.dll")]
        public static extern uint SetClassLong(HandleRef hWnd, int nIndex, uint dwNewLong);
        ...
        /// </summary>
        /// <param name="hdc"></param>
        /// <param name="unColor"></param>
        /// <returns></returns>
        [DllImport("gdi32.dll ")]
        public static extern UInt32 SetBkColor(IntPtr hdc, UInt32 unColor);
