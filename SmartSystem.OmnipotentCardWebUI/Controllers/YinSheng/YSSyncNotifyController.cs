...
namespace SmartSystem.OmnipotentCardWebUI.Controllers.YinSheng
{
    ...
    /// 银盛同步通知
    /// </summary>
    public class YSSyncNotifyController : Controller
    {
        public void Index()
        {
            try
            ...
            {
                ExceptionsServices.AddExceptionToDbAndTxt("YSSyncNotify", "支付通知出错", ex, LogFrom.WeiXin);
