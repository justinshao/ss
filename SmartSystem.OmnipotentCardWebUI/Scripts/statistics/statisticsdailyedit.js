...
function ExportTest() {
    ...
    $.ajax({
        type: "post",
        url: '/S/Statistics/Export_DailyEdit',
...
$(function () {
    ...
    $('#txtStartTime').datetimebox('setValue', currentdateDay() + " 00:00:00");
    $('#txtEndTime').datetimebox('setValue', formatterDate(new Date()));
    BindGetParkTree();
    $("#btnQueryData").click(function () {
        ...
        options.url = "/S/Statistics/Search_DailyStatisticsEdit";
