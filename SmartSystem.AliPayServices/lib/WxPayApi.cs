...
namespace SmartSystem.AliPayServices.lib
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, WX_ApiConfig config , int timeOut = 10)
        {
            ...
            inputObj.SetValue("spbill_create_ip", config.ServerIP);//终端ip
            ...
            string response = HttpService.Post(xml, url, false, timeOut,config);//调用HTTP通信接口以提交数据到API
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj,WX_ApiConfig config, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, false, timeOut,config);//调用HTTP通信接口提交数据
        ...
        */
        public static WxPayData Refund(WxPayData inputObj,WX_ApiConfig config, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, true, timeOut,config);//调用HTTP通信接口提交数据到API
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData RefundQuery(WxPayData inputObj,WX_ApiConfig config, int timeOut = 6)
	    {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData DownloadBill(WxPayData inputObj,WX_ApiConfig config, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, WX_ApiConfig config, int timeOut = 6)
        {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj,WX_ApiConfig config)
	    {
		    //如果不需要进行上报
	    ...
	    */
	    public static WxPayData Report(WxPayData inputObj,WX_ApiConfig config, int timeOut = 1)
	    {
		    ...
		    inputObj.SetValue("appid", config.AppId);//公众账号ID
		    inputObj.SetValue("mch_id", config.PartnerId);//商户号
		    inputObj.SetValue("user_ip", config.ServerIP);//终端ip
