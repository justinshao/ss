...
{
    class ValiVIPInRecordRuleHandler : RuleHandler
    {
        ...
        private void FindNestAreaIorecord(InputAgs args, ResultAgs rst)
        {
            ...
            var timeseries = ParkTimeseriesServices.GetTimeseriesesByIORecordID(args.AreadInfo.PKID, args.NestAreaIORecord==null?"": args.NestAreaIORecord.RecordID, out errorMsg);
